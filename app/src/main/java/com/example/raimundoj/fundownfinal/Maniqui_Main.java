...
public class Maniqui_Main extends Animaciones implements View.OnTouchListener,View.OnClickListener{
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Maniqui_Main.this, Deporte_Main.class);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.home:
                ...
                Intent intent = new Intent(Maniqui_Main.this, MainActivity.class);
                startActivity(intent);
            ...
            case R.id.again:
                ...
                intent = new Intent(Maniqui_Main.this, Maniqui_Main.class);
                startActivity(intent);
                break;

            case R.id.back:

                intent = new Intent(Maniqui_Main.this, Deporte_Main.class);
                startActivity(intent);
